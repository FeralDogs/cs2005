...
public class CreateAccount extends JFrame {
    ...
    public CreateAccount() {
        ...
        btnCreateAccount.addActionListener(new ActionListener() {
            ...
            int count = CreateAccount.getCount();
            int ctrl = 1;
            ...
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    if (ctrl == 1) {
                        ...
                        User obj1 = new User("bob", "3");
                        User obj2 = new User("john", "3");
                        User obj3 = new User("dave", "3");
                        User obj4 = new User("jill", "3");
                        User obj5 = new User("g", "3");
                        User obj6 = new User("a", "3");
                        
                        User obj7 = new User("User1", "3");
                        ...
                        CreateAccount.users.add(currentUser);

                        Path currentRelativePath = Paths.get("");
                        String s = currentRelativePath.toAbsolutePath().toString();

                        File file = new File("C:\\Users\\Adrian\\Documents\\NewFolder\\JavaApplication37\\src\\javaapplication37\\UsersData\\" + tempUsername);
